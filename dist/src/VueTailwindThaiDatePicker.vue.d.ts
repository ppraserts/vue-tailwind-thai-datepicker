...
declare namespace _sfc_main {
    namespace props {
        ...
        namespace modelValue {
            const type_13: (StringConstructor | ArrayConstructor | ObjectConstructor)[];
            export { type_13 as type };
            function _default_13(): any[];
            export { _default_13 as default };
        }
        namespace startFrom {
            const type_14: (StringConstructor | ObjectConstructor)[];
            export { type_14 as type };
            function _default_14(): Date;
    ...
    function setup(__props: any, { expose, emit }: {
        ...
        displayDateTime: (pickerValue: any) => any;
        VtdHeader: {
            props: {
