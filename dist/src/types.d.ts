...
declare namespace VueTailwindThaiDatePicker {
  interface Formatter {
    date?: string
    month?: string
  }
...
export interface DatepickerProps {
  ...
  separator?: string
  formatter?: VueTailwindThaiDatePicker.Formatter
  modelValue:
    | [Date, Date]
  ...
  options?: VueTailwindThaiDatePicker.Options
}
...
declare type VueTailwindThaiDatePicker = DefineComponent<
  DatepickerProps,
  TypedDatepickerData,
  unknown,
  ComputedOptions,
...
declare const component: VueTailwindThaiDatePicker
